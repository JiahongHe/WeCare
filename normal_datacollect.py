...
def data_collect(args):
        ...
        with open("Normal_Y_Accelerometer.csv","ab") as csvfile: 
            writer = csv.writer(csvfile)
            writer.writerow(Y_Ac)
        with open("Normal_Z_Accelerometer.csv","ab") as csvfile: 
            writer = csv.writer(csvfile)
            writer.writerow(Z_Ac) 
        with open("Normal_X_Gyroscope.csv","ab") as csvfile: 
            writer = csv.writer(csvfile)
            writer.writerow(X_Gy)
        with open("Normal_Y_Gyroscope.csv","ab") as csvfile: 
            writer = csv.writer(csvfile)
            writer.writerow(Y_Gy)
        with open("Normal_Z_Gyroscope.csv","ab") as csvfile: 
            writer = csv.writer(csvfile)
